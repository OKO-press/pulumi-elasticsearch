module github.com/OKO-press/pulumi-elasticsearch/provider
...
require (
	github.com/OKO-press/terraform-provider-elasticsearch/v2 v2.0.6
...
require (
	...
	github.com/phillbaker/terraform-provider-elasticsearch v1.6.3 // indirect
