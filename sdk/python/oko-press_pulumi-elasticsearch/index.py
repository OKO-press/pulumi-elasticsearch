...
class IndexArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] aliases: A JSON string describing a set of aliases. The index aliases API allows aliasing an index with a name, with all APIs
        ...
        :param pulumi.Input[str] auto_expand_replicas: Set the number of replicas to the node count in the cluster. Set to a dash delimited lower and upper bound (e.g. 0-5) or
        ...
        :param pulumi.Input[str] codec: The `default` value compresses stored data with LZ4 compression, but this can be set to `best_compression` which uses
               DEFLATE for a higher compression ratio. This can be set only on creation.
        :param pulumi.Input[str] default_pipeline: The default ingest node pipeline for this index. Index requests will fail if the default pipeline is set and the
        ...
        :param pulumi.Input[str] include_type_name: A string that indicates if and what we should pass to include_type_name parameter. Set to `"false"` when trying to
        ...
        :param pulumi.Input[str] indexing_slowlog_source: Set the number of characters of the `_source` to include in the slowlog lines, `false` or `0` will skip logging the
        ...
        :param pulumi.Input[str] mappings: A JSON string defining how documents in the index, and the fields they contain, are stored and indexed. To avoid the
        ...
        :param pulumi.Input[str] max_inner_result_window: The maximum value of `from + size` for inner hits definition and top hits aggregations to this index. A stringified
               number.
        :param pulumi.Input[str] max_ngram_diff: The maximum allowed difference between min_gram and max_gram for NGramTokenizer and NGramTokenFilter. A stringified
               number.
        ...
        :param pulumi.Input[str] max_shingle_diff: The maximum allowed difference between max_shingle_size and min_shingle_size for ShingleTokenFilter. A stringified
               number.
        ...
        :param pulumi.Input[str] number_of_routing_shards: Value used with number_of_shards to route documents to a primary shard. A stringified number. This can be set only on
               creation.
        :param pulumi.Input[str] number_of_shards: Number of shards for the index. This can be set only on creation.
        :param pulumi.Input[str] refresh_interval: How often to perform a refresh operation, which makes recent changes to the index visible to search. Can be set to `-1`
               to disable refresh.
        ...
        :param pulumi.Input[str] shard_check_on_startup: Whether or not shards should be checked for corruption before opening. When corruption is detected, it will prevent the
    ...
    def aliases(self) -> Optional[pulumi.Input[str]]:
        """
        A JSON string describing a set of aliases. The index aliases API allows aliasing an index with a name, with all APIs
        automatically converting the alias name to the actual index name. An alias can also be mapped to more than one index,
        and when specifying it, the alias will automatically expand to the aliased indices.
        """
    ...
    def include_type_name(self) -> Optional[pulumi.Input[str]]:
        """
        A string that indicates if and what we should pass to include_type_name parameter. Set to `"false"` when trying to
        create an index on a v6 cluster without a doc type or set to `"true"` when trying to create an index on a v7 cluster
        with a doc type. Since mapping updates are not currently supported, this applies only on index create.
        """
    ...
    def mappings(self) -> Optional[pulumi.Input[str]]:
        """
        A JSON string defining how documents in the index, and the fields they contain, are stored and indexed. To avoid the
        complexities of field mapping updates, updates of this field are not allowed via this provider. See the upstream
        [Elasticsearch
        docs](https://www.elastic.co/guide/en/elasticsearch/reference/6.8/indices-put-mapping.html#updating-field-mappings) for
        more details.
    ...
    def max_inner_result_window(self) -> Optional[pulumi.Input[str]]:
        """
        The maximum value of `from + size` for inner hits definition and top hits aggregations to this index. A stringified
        number.
        """
    ...
    def max_ngram_diff(self) -> Optional[pulumi.Input[str]]:
        """
        The maximum allowed difference between min_gram and max_gram for NGramTokenizer and NGramTokenFilter. A stringified
        number.
        """
    ...
    def max_shingle_diff(self) -> Optional[pulumi.Input[str]]:
        """
        The maximum allowed difference between max_shingle_size and min_shingle_size for ShingleTokenFilter. A stringified
        number.
        """
    ...
    def number_of_routing_shards(self) -> Optional[pulumi.Input[str]]:
        """
        Value used with number_of_shards to route documents to a primary shard. A stringified number. This can be set only on
        creation.
        """
...
class Index(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="numberOfReplicas")
    def number_of_replicas(self) -> pulumi.Output[Optional[str]]:
        """
        Number of shard replicas. A stringified number.
        """
        return pulumi.get(self, "number_of_replicas")
