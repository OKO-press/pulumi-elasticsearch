...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] url: Elasticsearch URL
        :param pulumi.Input[str] aws_access_key: The access key for use with AWS Elasticsearch Service domains
        :param pulumi.Input[str] aws_assume_role_arn: Amazon Resource Name of an IAM Role to assume prior to making AWS API calls.
        :param pulumi.Input[str] aws_profile: The AWS profile for use with AWS Elasticsearch Service domains
        :param pulumi.Input[str] aws_region: The AWS region for use in signing of AWS elasticsearch requests. Must be specified in order to use AWS URL signing with
               AWS ElasticSearch endpoint exposed on a custom DNS domain.
        :param pulumi.Input[str] aws_secret_key: The secret key for use with AWS Elasticsearch Service domains
        :param pulumi.Input[str] aws_signature_service: AWS service name used in the credential scope of signed requests to ElasticSearch.
        :param pulumi.Input[str] aws_token: The session token for use with AWS Elasticsearch Service domains
        :param pulumi.Input[str] cacert_file: A Custom CA certificate
        :param pulumi.Input[str] client_cert_path: A X509 certificate to connect to elasticsearch
        :param pulumi.Input[str] client_key_path: A X509 key to connect to elasticsearch
        :param pulumi.Input[str] elasticsearch_version: ElasticSearch Version
        :param pulumi.Input[bool] healthcheck: Set the client healthcheck option for the elastic client. Healthchecking is designed for direct access to the cluster.
        ...
        :param pulumi.Input[str] kibana_url: URL to reach the Kibana API
        :param pulumi.Input[str] password: Password to use to connect to elasticsearch using basic auth
        :param pulumi.Input[bool] sign_aws_requests: Enable signing of AWS elasticsearch requests. The `url` must refer to AWS ES domain (`*.<region>.es.amazonaws.com`), or
               `aws_region` must be specified explicitly.
        :param pulumi.Input[bool] sniff: Set the node sniffing option for the elastic client. Client won't work with sniffing if nodes are not routable.
        ...
        :param pulumi.Input[str] username: Username to use to connect to elasticsearch using basic auth
...
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter(name="kibanaUrl")
    def kibana_url(self) -> pulumi.Output[Optional[str]]:
        """
        URL to reach the Kibana API
        """
        return pulumi.get(self, "kibana_url")
