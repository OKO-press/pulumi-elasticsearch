...
namespace OKO.press.Elasticsearch
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("OKO.press.Elasticsearch.version.txt");
    ...
    internal sealed class ElasticsearchResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ElasticsearchResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
