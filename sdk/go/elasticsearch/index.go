...
type Index struct {
	...
	NumberOfReplicas pulumi.StringPtrOutput `pulumi:"numberOfReplicas"`
...
func NewIndex(ctx *pulumi.Context,
	...
	var resource Index
	err := ctx.RegisterResource("elasticsearch:index/index:Index", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIndex(ctx *pulumi.Context,
	...
	var resource Index
	err := ctx.ReadResource("elasticsearch:index/index:Index", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Number of shard replicas. A stringified number.
func (o IndexOutput) NumberOfReplicas() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Index) pulumi.StringPtrOutput { return v.NumberOfReplicas }).(pulumi.StringPtrOutput)
}
